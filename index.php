...
<p>
  <input type="submit" value="Best of 3 System" formaction="BO3game.php"> Don't reuse Court Name in this system
</p>
<p>
  <input type="submit" value="Accumulated Point System" formaction="APSgame.php"> Traditional system
</p>
</form>
